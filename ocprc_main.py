...
column10 = ['pat_id', 'rc_date', 'cohort', 'yob', 'race', 'ethnicity', 'bmi', 'yod', 'fh_breast', 'ph_breast',
...
column11 = ['pat_id', 'rc_date', 'cohort', 'dementia', 'cog_impair', 'parkinsons', 'osteoperosis', 'ischemic_hd',
            'myocard_infarc', 'aff_mood_disorders', 'anxiety', 'depression', 'fem_sex_dysf', 'stroke',
            'deep_vein_thromb', 'pulm_emb', 'genital_prolapse']
column12 = ['pat_id', 'rc_date', 'cohort', 'dementia', 'cog_impair', 'parkinsons', 'osteoperosis', 'ischemic_hd',
            'myocard_infarc', 'aff_mood_disorders', 'anxiety', 'depression', 'fem_sex_dysf', 'stroke',
...
special_cols = ['pat_id', 'rc_date', 'cohort']
...
print('* hyp column: ', data_set_10['hypertensive'])
print('* hyp count: ', data_set_10['hypertensive'].count('Y'))
...
print('* aff mood dis column: ', data_set_11['aff_mood_disorders'])
print('* amd not count: ', data_set_11['aff_mood_disorders'].count('N'))
print('* amd count: ', s10_11_12 - data_set_11['aff_mood_disorders'].count('N'))
